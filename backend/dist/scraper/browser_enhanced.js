...
class BrowserManager {
    ...
    static async initializeBrowser(options = {}) {
        const { headless = true, timeout = 30000, loadMoreClicks = 5, scrollDelay = 1000 } = options;
        try {
     ...
     */
    static async navigateToUrl(session, url, waitSelector) {
        try {
     ...
     */
    static async loadMoreArticles(session, loadMoreSelector, maxClicks = 5, scrollDelay = 1000) {
        let clickCount = 0;
        try {
     ...
     */
    static async scrollToBottom(session, scrollDelay = 1000) {
        let scrollCount = 0;
        try {
            ...
            while (currentPosition < scrollHeight) {
                ...
                const newHeight = await session.page.evaluate(() => document.documentElement.scrollHeight);
     ...
     */
    static async getPageContent(session) {
        try {
     ...
     */
    static async takeScreenshot(session, filename) {
        try {
     ...
     */
    static async closeBrowser(session) {
        try {
     ...
     */
    static async executeScript(session, script) {
        try {
     ...
     */
    static async waitForSelector(session, selector, timeout = 10000) {
        try {
...
//# sourceMappingURL=browser_enhanced.js.map
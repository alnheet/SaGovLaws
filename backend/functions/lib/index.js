...
exports.updateNotificationPreferences = exports.registerFcmToken = exports.dailySummaryNotification = exports.onArticleCreated = void 0;
...
exports.onArticleCreated = functions
    ...
    try {
        ...
        const generalMessage = Object.assign(Object.assign({}, message), { topic: 'news_updates' });
 ...
 */
exports.dailySummaryNotification = functions
    .region('me-west1')
    .pubsub.schedule('0 8 * * *')
 ...
 */
exports.updateNotificationPreferences = functions
    .region('me-west1')
    .https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    ...
    try {
        ...
        const tokens = (userData === null || userData === void 0 ? void 0 : userData.fcm_tokens) || [];
        // Update preferences
        await userRef.set({
